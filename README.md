...
- 👯 I’m looking to collaborate on improving the code of [**Blender QLE**][5], my lighting addon for Blender. *(It's "Hello World"-level basic, and I could use some mentoring in using vars and arrays to slim it down.)*
