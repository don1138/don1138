...
- 👯 I’m looking to collaborate on improving the code of [**Blender QLE**][5], my lighting addon for Blender. *(It functions well, but the code is about as sophisticated as "Hello World". I could use some mentoring in techniques to optimize and slim it down.)*
